 ...
 * @param {Function} onChange - (optional) callback of form (text) => {...}, called when user types or selects a value. updates letter by letter
 ...
 * @param {Object} style - style object for the root view of this component
 * @param {Object} style - style object for the text input 
 * @param {Object} style - style object for the select menu
 ...
 * @param {Number} menuHeight - height of menu that shows autocomplete values, before scrolling is necessary
 */
  ...
  return (
    <View style={ style }>
      <Input
        ...
        onChangeText={txt => updateText(txt) || (onChange && onChange(txt))}
        value={inputText}
        ref={inputRef}
